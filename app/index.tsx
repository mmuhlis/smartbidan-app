...
export default function Login() {
  ...
  const handleLogin = async () => {
    ...
    try {
      ...
      const endpoint =
        role === "bidan"
          ? "http://192.168.201.212:8000/api/bidan/login"
          : "http://192.168.201.212:8000/api/user/login";
  ...
  return (
    <View style={styles.container}>
      ...
      {/* <View style={styles.registerContainer}>
        ...
        <TouchableOpacity onPress={() => router.push("/registrasi-bidan")}>
          <Text style={styles.registerButton}>Daftar sebagai Bidan</Text>
        </TouchableOpacity>
        <TouchableOpacity onPress={() => router.push("/registrasi-pasien")}>
